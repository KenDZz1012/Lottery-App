...
const AnalysisResultSpecialA = () => {
  ...
  const onFetchCalResult = async (categoryId) => {
    ...
    const res = await axios.get(
      `http://192.168.1.17:5000/api/v1/result/CalResultHead?type=specialprize&categoryId=${categoryId}`
    );
    if (res.status == 200) {
...
export default AnalysisResultSpecialA;
